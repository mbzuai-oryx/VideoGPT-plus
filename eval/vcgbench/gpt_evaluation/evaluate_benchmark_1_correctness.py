"""
    VCGBench - Evaluation Script for Correctness of Information (CI) using gpt-3.5-turbo-0613

    Exactly the same prompts are used as proposed in https://github.com/mbzuai-oryx/Video-ChatGPT for a fair comparison with previous methods.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="VCGBench - Evaluation Script for Correctness of Information (CI).")
