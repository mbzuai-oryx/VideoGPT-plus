"""
    VCGBench - Evaluation Script for Detailed Orientation (DO) using gpt-3.5-turbo-0613
...
def parse_args():
    parser = argparse.ArgumentParser(description="VCGBench - Evaluation Script for Detailed Orientation (DO).")
