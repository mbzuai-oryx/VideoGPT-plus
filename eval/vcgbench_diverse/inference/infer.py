...
from eval.vcgbench_diverse.inference.ddp import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video-folder", type=str, default="MBZUAI/VCGBench-Diverse/videos")
    parser.add_argument("--question-file", type=str, default="MBZUAI/VCGBench-Diverse/vcgbench_diverse_qa.json")
    parser.add_argument("--output-dir", type=str, default="MBZUAI/VideoGPT-plus_Phi3-mini-4k/vcgbench/vcgbench_diverse_eval/answer-vcgbench-diverse")
